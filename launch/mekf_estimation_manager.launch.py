...
def load_ekf_path(context, *args, **kwargs):
    ...
    ekf_params_path = os.path.join(
        estimators_pkg_share, 'params', 'mekf_fast_lio_state_estimator.yaml'
    )
...
def generate_launch_description():
    ...
    estimation_manager_node = LifecycleNode(
        ...
        executable='mekf_estimation_manager_main',
        name='mekf_estimation_manager',
        ...
        remappings=[
            ...
            ('odometry_predict', 'mekf_estimation_manager/estimation_predict'),
            ('set_odometry', 'set_odometry'),
            ('diagnostics', 'mekf_estimation_manager/diagnostics'),
        ]
    )
