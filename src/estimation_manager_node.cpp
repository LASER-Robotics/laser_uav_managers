...
namespace laser_uav_managers
{
  ...
  void EstimationManager::setupEKF()
  {
    ...
    ekf_ = std::make_unique<laser_uav_estimators::StateEstimator>(mass_, motor_positions, thrust_coefficient_, torque_coefficient_, inertia, ekf_verbosity_);
      ...
      std::shared_ptr<laser_msgs::srv::SetString::Response> response)
  {
    ...
    Eigen::Vector3d current_position(current_state(laser_uav_estimators::State::PX), current_state(laser_uav_estimators::State::PY), current_state(laser_uav_estimators::State::PZ));
    ...
    Eigen::Quaterniond current_orientation(current_state(laser_uav_estimators::State::QW), current_state(laser_uav_estimators::State::QX), current_state(laser_uav_estimators::State::QY), current_state(laser_uav_estimators::State::QZ));
    ...
    Eigen::Vector3d current_linear_velocity(current_state(laser_uav_estimators::State::VX), current_state(laser_uav_estimators::State::VY), current_state(laser_uav_estimators::State::VZ));
    ...
    Eigen::Vector3d current_angular_velocity(current_state(laser_uav_estimators::State::WX), current_state(laser_uav_estimators::State::WY), current_state(laser_uav_estimators::State::WZ));
