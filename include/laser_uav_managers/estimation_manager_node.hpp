...
namespace laser_uav_managers
{
  ...
  private:
    ...
    /* EKF //{ */
    std::unique_ptr<laser_uav_estimators::StateEstimator> ekf_; ///< Unique pointer to the StateEstimator instance.
    /*//}*/
    ...
    laser_uav_estimators::ProcessNoiseGains process_noise_gains_;         ///< Struct holding process noise gains for the EKF.
    laser_uav_estimators::MeasurementNoiseGains measurement_noise_gains_; ///< Struct holding measurement noise gains for the EKF.
