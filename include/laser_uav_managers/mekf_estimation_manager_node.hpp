...
class MekfEstimationManager : public rclcpp_lifecycle::LifecycleNode {
public:
  explicit MekfEstimationManager(const rclcpp::NodeOptions &options = rclcpp::NodeOptions());

  ~MekfEstimationManager() override;
...
private:
  ...
  SensorDataBuffer<nav_msgs::msg::Odometry>                odom_data_;
